...
- Recovered identifiers: 8648
- Recovered strings: 10780
- Logical function entries: 36 across 36 unique AOT code ranges
- Source-view functions: 36; evidence-only runtime/boundary functions: 0
- Dart VM-linked function entries: 0
- Dart VM-linked declarations: 0
- Function declarations: 32 with standalone code, 2 without standalone code
- Resolved snapshot types: 13 return types, 11 parameter types, 0 named parameter names
- Typed declarations: 11 classes with metadata, 1 fields with declared types
- Direct call sites: 249 (247 code targets, 129 semantic targets); indirect call sites: 10
