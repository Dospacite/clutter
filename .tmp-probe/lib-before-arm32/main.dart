...
void main_tearOff() {
  ...
  return aot.unresolvedRegion('Remaining behavior of main', <dynamic>[]);
}
...
class ProbeApp extends StatelessWidget {
  ...
  Center closure_30679(BuildContext arg0) {
    ...
    if (seedNowResult == (seedNowResult << 1)) {  /* low-confidence predicate */
      if ((r0 & 1) == 0) {  /* low-confidence predicate */
        ...
        if (local10 < 0) {  /* low-confidence predicate */
          if (r6 == r0) {  /* low-confidence predicate */
            ...
            if ((seedNowResult & 1) != 0) {  /* low-confidence predicate */
              final fromLiteralResult =
                aot.invoke('Map._fromLiteral', <dynamic>[aot.unresolvedValue('(sub_318cac_result + 15)'), local10, linearTextScalerResult]);
              ...
              final e01InterpChainResult = e01InterpChain('${snapshotRef(744)}${local14}');
              final textResult = Text();
              final interpolateSingleResult =
                aot.invoke('String._interpolateSingle', <dynamic>[aot.unresolvedValue('shared-code result'), aot.unresolvedValue('(sub_318cac_result + 11)'), local14]);
              ...
              if ((textResult2 & 1) == 0) {  /* low-confidence predicate */
                ...
                if (equalsResult != r0) {  /* low-confidence predicate */
                  final equalsResult2 = aot.invoke('String.==', <dynamic>[equalsResult]);
                  if (equalsResult2 == r0) {  /* low-confidence predicate */
                    final textResult3 = Text(linearTextScalerResult, local4);
                    if ((textResult3 & 1) == 0) {  /* low-confidence predicate */
                      final e04BitTwiddleResult = e04BitTwiddle(seedNowResult, local10, linearTextScalerResult);
                                ...
                                if ((_Result6 & 1) == 0) {  /* low-confidence predicate */
                                  ...
                                  if ((textResult7 & 1) == 0) {  /* low-confidence predicate */
                                    final _Result7 =
                                      aot.invoke('_IntegerImplementation.%', <dynamic>[aot.unresolvedValue('shared-code result'), linearTextScalerResult]);
                                    while (r3 < r2) {
                                      if (r0 < r1) {  /* low-confidence predicate */
                                      }
                                      while (r6 < r2) {
                                        if (r4 < r1) {  /* low-confidence predicate */
                                        }
                    ...
                    if (equalsResult3 != r0) {  /* low-confidence predicate */
                    }
                  }
                } else {
                }
      ...
      if ((textResult8 & 1) == 0) {  /* low-confidence predicate */
        if ((seedNowResult & 1) != 0) {  /* low-confidence predicate */
          final interpolateSingleResult8 =
            aot.invoke('String._interpolateSingle', <dynamic>[aot.unresolvedValue('shared-code result'), linearTextScalerResult, local14]);
          final e09TryRethrowResult = e09TryRethrow(local14, local10);
                  ...
                  if ((textResult12 & 1) == 0) {  /* low-confidence predicate */
                    ...
                    if (bumpResult == (bumpResult << 1)) {  /* low-confidence predicate */
                      ...
                      if ((textResult13 & 1) == 0) {  /* low-confidence predicate */
                        ...
                        e15VecResult._slot_4 = local10; // AOT field store +0x4
                        e15VecResult._slot_8 = local34; // AOT field store +0x8
                        ...
                        if (compareToResult == (compareToResult << 1)) {  /* low-confidence predicate */
                          ...
                          if ((textResult14 & 1) == 0) {  /* low-confidence predicate */
                            ...
                            final interpolateSingleResult13 =
                              aot.invoke('String._interpolateSingle', <dynamic>[setResult, aot.snapshotRef(47653), local14]);
                            final addResult =
                            ...
                            if ((textResult15 & 1) == 0) {  /* low-confidence predicate */
                              final e17JsonRoundTripResult = e17JsonRoundTrip('[{"a":${local14}},{"b":null}]');
                                  ...
                                  if ((textResult18 & 1) == 0) {  /* low-confidence predicate */
                                    ...
                                    if ((textResult19 & 1) == 0) {  /* low-confidence predicate */
                                      ...
                                      if (parseResult == snapshotInstance(E21Mode)) {  /* low-confidence predicate */
                                        final textResult20 = Text(local14, (seedNowResult & 1), local4);
                                              ...
                                              if (e24KnotResult == (e24KnotResult << 1)) {  /* low-confidence predicate */
                                                ...
                                                if ((textResult23 & 1) == 0) {  /* low-confidence predicate */
                                                  final e25IntrinsicsResult =
                                                    e25Intrinsics('${snapshotRef(130)}${local4}');
                                                  if (e25IntrinsicsResult != r0) {  /* low-confidence predicate */
                                                    final textResult24 =
                                        ...
                                        if (r1 < 0) {  /* low-confidence predicate */
                                          ...
                                          if (r2 >= 0) {  /* low-confidence predicate */
                                          }
                                        }
                                      }
                                    } else {
  ...
  String closure_31254() {
    return '${snapshotRef(576)}${aot.unresolvedValue('interpolated part')}';
  }
